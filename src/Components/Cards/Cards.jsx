  ...
  return (
    <div className='big_container '>
      <div className="container_cards">
        ...
        // onClick={() => { /* Open a new page with the big image */ }}
        >
      ...
      <div className="container_infos">
                    ...
                    <h1 id="titre_produit">Fall Limited Edition<br>Sneakers</h1>
                    ...
                    <div className="boxs">
                        <div className="button1">
                            <button id="plus-btn"><img src="./images/icon-plus.svg" className="btn-plus" alt="Plus"></button>
                            <div className="number" id="quantity">1</div>
                            <button id="minus-btn"><img src="./images/icon-minus.svg" className="btn-minus" alt="Minus"></button>
                        </div>
